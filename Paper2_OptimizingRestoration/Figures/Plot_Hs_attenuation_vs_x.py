...
ax[0].add_patch(matplotlib.patches.Rectangle((0.01, 0.255), 0.535, 0.31,
                edgecolor='black',
                facecolor='white',
                lw=1))
...
[ax[i].set_ylim(0.25, 1) for i in range(0, 3)]

# Save figure
if save_figures:
    fname = 'HsNorm_vs_x_Tw_D.png'

...
six = np.where(models.waveHeight == 0.6)[0].tolist()
nine = np.where(models.waveHeight == 0.9)[0].tolist()
waves = [six, nine]

plt.style.use('_mpl-gallery')
f1 = plt.figure(figsize=(8, 6))
axes1 = f1.add_axes([0.1, 0.35, 0.4, 0.55])
axes2 = f1.add_axes([0.55, 0.35, 0.4, 0.55])
ax = [axes1, axes2]

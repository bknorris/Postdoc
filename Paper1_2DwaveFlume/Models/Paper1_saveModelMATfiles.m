...
workingDir = 'd:\USGS\Models\Paper1_2DwaveFlume\ModelRuns\HR_Domain\DataAnalysis\';
% modelDir = 'c:\Users\user\Documents\Models\Paper1_2DwaveFlume\ModelRuns\HR_Domain\Scenarios\';
modelDir = 'd:\USGS\Models\Paper1_2DwaveFlume\ModelRuns\HR_Domain\Scenarios\';
modelInfo = 'HR_Domain_models_toRun.csv';
...
% workingDir = 'd:\USGS\Models\Paper1_2DwaveFlume\ModelRuns\LR_Domain\DataAnalysis\';
% % modelDir = 'c:\Users\user\Documents\Models\Paper1_2DwaveFlume\ModelRuns\LR_Domain\Scenarios\';
% modelDir = 'd:\USGS\Models\Paper1_2DwaveFlume\ModelRuns\LR_Domain\Scenarios\';
...
for i = 1:length(modelScenarios)
    ...
    if isempty(modelID) %process only the folders listed in the CSV file
        ...
        if saveData == 1
            save([workingDir modelScenarios{i} '_rawData_' versionNO '.mat'],'data','-mat','-v7.3')
        end
        clear data

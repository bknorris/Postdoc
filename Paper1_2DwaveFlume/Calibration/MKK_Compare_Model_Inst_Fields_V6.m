...
modelLegendText = {'Observations';'V2'};
...
elseif multipleLines == 1
    ...
    modelLegendText = {'Observations';'line1';'line2';'line3';'line4';'line5';'line6';'line7';'line8';'line9'};
    if length(RBRbursts) == 1
        burstTxt = sprintf('%d',RBRbursts(1));
    else
        burstTxt = sprintf('%d-%d',RBRbursts(1),RBRbursts(2));
...
if saveFigs == 1
    export_fig(ff(1),[figPath modelFigName '_AQDP_MODEL-Fields_V6'],'-png','-r600','-nocrop')
end
if saveData == 1
    ...
    data.E_m = E_m;
    save([dataPath modelFigName '_calibrationProfiles_V6.mat'],'data','-mat','-v7.3')
end
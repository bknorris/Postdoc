...
% 02/26/21: Added windowing to instrument field calculations. Do not 
% recommend using this script (use V5 instead).
%
% This is version 6 of this script.
%
% BKN - USGS PCMSC 2021
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
modelNames = {'MKK_CombinedHR_V21';};
modelFigName = 'MKK_CombinedHR_V21_lines';
insts = 'MKK18HR101aqdHR-b.nc';
instName = {'C15';'HR-Aquadopp'};
modelLegendText = {'Observations';'V21'};
...
multipleModels = 1; %plot multiple models together; 0 is off, 1 is on
multipleLines = 0; %plot multiple lines together; 0 is off, 1 is on
...
elseif multipleLines == 1
    lineName = {'_alpha.water';'_U'};
    modelLegendText = {'Observations';'71.0';'71.1';'71.2';'71.3';'71.4';'71.5';'71.6';'71.7';'71.8';'71.9';'72.0'};
    if length(RBRbursts) == 1
        burstTxt = sprintf('%d',RBRbursts(1));
    else
        burstTxt = sprintf('%d-%d',RBRbursts(1),RBRbursts(2));
...
elseif multipleModels == 1 && multipleLines == 1
        error('Cannot plot multiple models and lines at the same time')
elseif multipleModels == 0 && multipleLines == 0
        error('User must specify either mutlipleModels or multipleLines')
end
...
if saveFigs == 1
    export_fig(ff(1),[figPath modelFigName '_AQDP_MODEL-Fields_V5'],'-png','-r600','-nocrop')
end

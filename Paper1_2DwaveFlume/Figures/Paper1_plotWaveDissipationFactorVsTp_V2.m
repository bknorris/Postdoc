...
leg1 = legend([pp; pfit2(2)],[legText; lineEqn],'location','southwest','box','on','interpreter','latex');
...
%Make best fit line legends
leg2 = legend([pp; pfit2(1)],[legText; lineEqn],'location','southwest','box','on','interpreter','latex');
...
set(sp(2),'xlim',[0.35 50],...
    'ylim',[0.001 10],...
    'yticklabel',[])
set(sp,'xscale','log','yscale','log')
set(leg1,'position',[0.122 0.185 0.2 0.15])
set(leg2,'position',[0.535 0.185 0.2 0.15])
...
% print(ff,[workingDir 'Models_allHR_LR_feVsAbKw_V2'],'-dpdf','-r0')

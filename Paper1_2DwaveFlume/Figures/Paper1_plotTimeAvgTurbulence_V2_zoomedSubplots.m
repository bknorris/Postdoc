...
% set(sp1,'xlim',[37 40])
% set(sp2,'xlim',[33 36])
% set([sp1(1) sp2(1)],'ylim',[-1 0],'ytick',-1:0.5:0)
% set([sp1(2) sp2(2)],'ylim',[-1.5 -0.5],'ytick',-1.5:0.5:-0.5)
% set([sp1(3) sp2(3)],'ylim',[-2.5 -1.5],'ytick',-2.5:0.5:-1.5)
% set([sp1(4) sp2(4)],'ylim',[-3.5 -2.5],'ytick',-3.5:0.5:-2.5)
% set([sp1(5) sp2(5)],'ylim',[-4.5 -3.5],'ytick',-4.5:0.5:-3.5)
% 
...
% 
% %Save figure
% export_fig(ff,[workingDir  'HR_LR_Tp_12s_TimeAvgd_Turbulence_V4'],'-png','-r600','-nocrop')

%% Minor subplots %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Global Adjustments
set(sp1,'xlim',[37 39.5])
set(sp2,'xlim',[33 35.5])

for i = 1:5
    caxis(sp1(i),[1e-9 1e-5])
    caxis(sp2(i),[1e-11 1e-7])
end

set(sp1(1),'position',[0.1 0.84 0.2 0.15],'xticklabel',[])
set(sp1(2),'position',[0.1 0.67 0.2 0.15],'xticklabel',[])
set(sp1(3),'position',[0.1 0.49 0.2 0.15],'xticklabel',[])
set(sp1(4),'position',[0.1 0.31 0.2 0.15],'xticklabel',[])
set(sp1(5),'position',[0.1 0.13 0.2 0.15])

set(sp2(1),'position',[0.55 0.84 0.2 0.15],'xticklabel',[])
set(sp2(2),'position',[0.55 0.67 0.2 0.15],'xticklabel',[])
set(sp2(3),'position',[0.55 0.49 0.2 0.15],'xticklabel',[])
set(sp2(4),'position',[0.55 0.31 0.2 0.15],'xticklabel',[])
set(sp2(5),'position',[0.55 0.13 0.2 0.15])

%Create legend
cb1 = colorbar(sp1(5),'location','southoutside');
set(cb1,'position',[0.1 0.05 0.2 0.02],...
    'tickdir','out',...
    'ticklength',0.01,...
    'linewidth',1.5);
cb2 = colorbar(sp2(5),'location','southoutside');
set(cb2,'position',[0.55 0.05 0.2 0.02],...
    'tickdir','out',...
    'ticklength',0.01,...
    'linewidth',1.5);
...
%Save figure
export_fig(ff,[workingDir  'HR_LR_Tp_12s_TimeAvgd_Turbulence_V4_zoomedSubplots'],'-png','-r600','-nocrop')
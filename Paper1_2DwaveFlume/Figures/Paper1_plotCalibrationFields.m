...
clear; close all
dataPath = 'c:\Users\user\Documents\Models\Paper1_2DwaveFlume\DataAnalysis\Calibration\';
figPath = 'c:\Users\user\Documents\Models\Paper1_2DwaveFlume\Figures\'; %where to save figs
modelFigName = 'HR_V27_LR_V2';
fileName{1} = 'MKK_CombinedHR_V27_calibrationProfiles_V6.mat';
fileName{2} = 'MKK_CombinedLR_V2_calibrationProfiles_V6.mat';
...
xlabel(sp(6),'$\varepsilon \ \mathrm{Measured \quad (m^2/s^3)}$','interpreter','latex')

ylabel(sp(1),'$z \quad \mathrm{(m)}$','interpreter','latex')
...
ylabel(sp(6),'$\varepsilon \ \mathrm{Modeled \quad (m^2/s^3)}$','interpreter','latex')

%Axes adjustments
set([sp(1) sp(2) sp(3)],'ylim',[0 0.6],'ytick',0:0.1:0.6)
...
print(ff1,[figPath modelFigName '_AQDP_MODEL-Cals_V3'],'-dpdf','-r0')
